...
```shell
curl -X GET \
  'https://api.nelnet.io/transactionapi/payments?loanid=c2d6aa46-ab71-475d-943a-dec948f99843' \
  -H 'Accept: */*' \
...
```csharp
var client = new RestClient("https://api.nelnet.io/transactionapi/payments?loanid=c2d6aa46-ab71-475d-943a-dec948f99843");
...
xhr.open("GET", "https://api.nelnet.io/transactionapi/payments?loanid=c2d6aa46-ab71-475d-943a-dec948f99843");
...
conn.request("GET", "transactionapi,payments", payload, headers)
  ...
  "data": [
    {
      ...
      "createdDate": "2020-08-05T20:52:34.086Z",
      "updatedDate": "2020-08-05T20:52:34.086Z",
      "isBackDated": true,
      "snapshotId": "string"
    }
  ]
...
**Returns all payment transactions for a loan.**

### HTTP Request

`GET https://api.nelnet.io/transactionapi/payments`

Parameter | Required | Type   | Description
----------| -------- | ------ | -----------
loanid | yes | string | The identifier for the loan.
feetype | no | string | The type of fee.
startdate | no | string | The starting date of the period to return records from.
enddate | no | string | The end date of the period to return records from.
includereversals | no | boolean | Defaults to false.
