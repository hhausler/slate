...
**Adds a single custom data value to a loan record.**

### HTTP Request

`POST https://api.nelnet.io/loanapi/loans/{loanid}/customdata/{key}`

Parameter | Required | Type   | Description
----------| -------- | ------ | -----------
loanid    | yes      | string | The identifier for the loan. (Path parameter.)
key       | yes      | string | The key for the custom data field to delete. (Path parameter.)
value     | yes      | string | The value of the custom data field to add. (Path parameter.)
