...
## Add or Update Custom Data for a Loan

### POST /loans/{loanid}/customdata
...
```shell
curl -X POST \
  https://api.nelnet.io/loanapi/loans/2c809e08-a5ba-4559-9c1c-4ac2555fb1e6/customdata \
  -H 'Accept: */*' \
...
```csharp
var client = new RestClient("https://api.nelnet.io/loanapi/loans/2c809e08-a5ba-4559-9c1c-4ac2555fb1e6/customdata");
...
xhr.open("POST", "https://api.nelnet.io/loanapi/loans/2c809e08-a5ba-4559-9c1c-4ac2555fb1e6/customdata");
...
conn.request("POST", "loanapi,loans,2c809e08-a5ba-4559-9c1c-4ac2555fb1e6,customdata", payload, headers)
...
**Adds or updates custom data to a loan record.**

<aside class="notice">The posted data will be merged with the loan’s existing custom data, overwriting the values of any matching keys and adding values for new keys.</aside>

### HTTP Request

`POST https://api.nelnet.io/loanapi/loans/{loanid}/customdata`

Parameter | Required | Type   | Description
----------| -------- | ------ | -----------
loanid    | yes      | string | The identifier for the loan. (Path parameter.)
(custom data)      | yes      | object | The custom data to add to the loan, in the form of a key-value JSON object. (Body parameter.)
