...
status | no | string | The loan modification status. Options: *Active, Inactive, Processing, Failure*. Leave blank to get all statuses.
...
effectiveDate | string | The date that the loan modification becomes effective.
endDate | string | The date that the loan modification ends.
