...
**Use this endpoint to add a new consumer loan and a new borrower to the system. The borrower object's fields are required unless you want to add a new loan to an existing borrower's record. To add a new loan, pass a borrowerID and the rest of the borrower object's fields will be skipped.**

### HTTP Request

`POST https://api.nelnet.io/onboardingapi-v2/onboarding/bundles/consumer`
...
itemId | no | string | An optional value that allows batches to be grouped and defined.
batchId | no | string | An optional value that allows batches to be grouped and defined.
...
borrower.address.street1 | yes | string | The address's first street line.
borrower.address.street2 | yes | string | The address's second street line.
borrower.address.city | yes | string | The address's city.
borrower.address.state | yes | string | The address's state.
borrower.address.postalCode | yes | string | The address's postal code.
borrower.address.countryCode | yes | string | The address's country code.
borrower.address.isPrimary | yes | boolean | Whether this address is known to be the borrower's primary address.
